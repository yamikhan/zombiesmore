...
public class ZombieDwarf extends AbstractMoZombie {
	...
	public static class RendererZombieDwarf extends HumanoidMobRenderer<AbstractMoZombie, ZombieDwarfModel<AbstractMoZombie>> {
		public final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ZombiesMoreFabric.MODID, "textures/entity/" + NAME + ".png");
	...
	public static class ZombieDwarfModel<T extends AbstractMoZombie> extends HumanoidModel<T> {
		...
		public static final ModelLayerLocation DWARF = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ZombiesMoreFabric.MODID, NAME), "main");
		public static final ModelLayerLocation DWARF_INNER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ZombiesMoreFabric.MODID, NAME + "_inner"), "main");
		public static final ModelLayerLocation DWARF_OUTER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ZombiesMoreFabric.MODID, NAME + "_outer"), "main");
